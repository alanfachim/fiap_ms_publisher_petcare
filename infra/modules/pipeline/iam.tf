resource "aws_iam_role" "codepipeline_role" {
  name               = "codepipeline-${var.cluster_name}-${var.app_path}-role"
...
resource "aws_iam_role_policy" "codepipeline_policy" {
  name   = "codepipeline-${var.cluster_name}-${var.app_path}-policy"
  role   = "${aws_iam_role.codepipeline_role.id}"
  policy = "${data.template_file.codepipeline_policy.rendered}"
}

resource "aws_iam_role" "codebuild_role" {
  name               = "codebuild-${var.cluster_name}-${var.app_path}-role"
...
resource "aws_iam_role_policy" "codebuild_policy" {
  name   = "codebuild-${var.cluster_name}-${var.app_path}-policy"
